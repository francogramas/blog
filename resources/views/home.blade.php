                ...
                @section ('pane2_panel_body')                    
                    ...
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Lorem ipsum dolor1</h4>
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Lorem ipsum dolor 2</h4>
                                </div>
                                <div class="timeline-body">
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Lorem ipsum dolor 3</h4>
                                </div>
                                <div class="timeline-body">
                        ...
                        <li class="timeline-inverted">
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Lorem ipsum dolor 4</h4>
                                </div>
                                <div class="timeline-body">
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Lorem ipsum dolor 5</h4>
                                </div>
                                <div class="timeline-body">
                        ...
                        <li>
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Lorem ipsum dolor 6</h4>
                                </div>
                                <div class="timeline-body">
                        ...
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4 class="timeline-title">Lorem ipsum dolor 7</h4>
                                </div>
                                <div class="timeline-body">
